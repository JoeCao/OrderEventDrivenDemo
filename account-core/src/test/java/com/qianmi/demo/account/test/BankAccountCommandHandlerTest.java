...
package com.qianmi.demo.account.test;
...
//    @Test
//    public void testDebitByorder() throws Exception {
//        String id = "bankAccountId";
//        testFixture.given(new BankAccountCreatedEvent(id, 0), new MoneyDepositedEvent(id, 50))
//                .when(new DebitAccountByOrderCommand("orderId", id, 50))
//                .expectEvents(new DebitAccountByOrderEvent(id, 50));
//    }
}